...
namespace MoveImprove.ivsdk
{
    internal class RunRework
    {
        ...
        public static void Init(SettingsFile settings)
        {
            ...
            SprintDrain = settings.GetFloat("RUN REWORK", "SprintDrain", 25.0f);
            RunDrain = settings.GetFloat("RUN REWORK", "RunDrain", 7.5f);
            WalkDrain = settings.GetFloat("RUN REWORK", "WalkDrain", 3.0f);
